...
5. **Spec 0050 `done`** — G4 pass 2026-07-29. Bug P2.11 (sao lưu đơ app) đã chữa: nén theo loại file, isolate, tiến trình, huỷ, confirm trước khi zip. Phần còn lại Orchestrator từng hỏi — *chọn sao lưu những gì* — vẫn là slice tier L riêng (ADR + Security Review), chưa draft.
