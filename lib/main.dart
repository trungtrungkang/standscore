...
import 'package:standscore/ui/library_screen.dart';

Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized();
  await pdfrxFlutterInitialize();
  runApp(const StandScoreApp());
}

class StandScoreApp extends StatefulWidget {
  const StandScoreApp({super.key});

  @override
  State<StandScoreApp> createState() => _StandScoreAppState();
}

class _StandScoreAppState extends State<StandScoreApp> {
